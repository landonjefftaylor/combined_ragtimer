...
#with open("8react_no_commute_result.txt", "w") as rto:
command = "/usr/bin/time -o 8react_no_commute_ragtimer_time.txt python3 ragtimer.py loose qty 1 > 8react_no_commute_result.txt"
...
#os.system(command)
print("Testing is complete for 8react without commuting.\n\nThe lower-bound probability is found in '8react_no_commute_result.txt' around line 80, the time RAGTIMER needed to run is found in '8react_no_commute_ragtimer_time.txt'")

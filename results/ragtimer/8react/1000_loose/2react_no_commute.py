...
#with open("2react_no_commute_result.txt", "w") as rto:
command = "/usr/bin/time -o 2react_no_commute_ragtimer_time.txt python3 ragtimer.py qty 1 > 2react_no_commute_result.txt"
...
#os.system(command)
print("Testing is complete for 2react without commuting.\n\nThe lower-bound probability is found in '2react_no_commute_result.txt' on line 63, the time RAGTIMER needed to run is found in '2react_no_commute_ragtimer_time.txt'")

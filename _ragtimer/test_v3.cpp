...
class ext__protocol__update_r2_gen : public gen {
  public:
    ext__protocol__update_r2_gen(test_v3&);
    bool generate(test_v3&);
    void execute(test_v3&);
};
ext__protocol__update_r2_gen::ext__protocol__update_r2_gen(test_v3 &obj){
    mk_bv("protocol.2bit",1);
    mk_bv("updater.exec_stage",3);
    mk_bv("updater.num",10);
    mk_bv("updater.exec_var",8);
...
class ext__protocol__update_r4_gen : public gen {
  public:
    ext__protocol__update_r4_gen(test_v3&);
    bool generate(test_v3&);
    void execute(test_v3&);
};
ext__protocol__update_r4_gen::ext__protocol__update_r4_gen(test_v3 &obj){
    mk_bv("protocol.2bit",1);
    mk_bv("updater.exec_stage",3);
    mk_bv("updater.num",10);
    mk_bv("updater.exec_var",8);
...
class ext__protocol__update_r7_gen : public gen {
  public:
    ext__protocol__update_r7_gen(test_v3&);
    bool generate(test_v3&);
    void execute(test_v3&);
};
ext__protocol__update_r7_gen::ext__protocol__update_r7_gen(test_v3 &obj){
    mk_bv("protocol.2bit",1);
    mk_bv("updater.exec_stage",3);
    mk_bv("updater.num",10);
    mk_bv("updater.exec_var",8);
...
class ext__protocol__update_r6_gen : public gen {
  public:
    ext__protocol__update_r6_gen(test_v3&);
    bool generate(test_v3&);
    void execute(test_v3&);
};
ext__protocol__update_r6_gen::ext__protocol__update_r6_gen(test_v3 &obj){
    mk_bv("protocol.2bit",1);
    mk_bv("updater.exec_stage",3);
    mk_bv("updater.num",10);
    mk_bv("updater.exec_var",8);
